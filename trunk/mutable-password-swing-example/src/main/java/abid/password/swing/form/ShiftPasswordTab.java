...
public class ShiftPasswordTab extends AbstractTab {
  ...
  public void initComponents(FormPanel form) {
    feedbackLabel = form.getLabel("shift.feedbackLabel");
    setFeedbackLabel(feedbackLabel);
    setInfo(null);
    usernameField = form.getTextField("shift.usernameField");
    passwordField = form.getTextField("shift.passwordField");
    parameterField = form.getComboBox("shift.parameterField");
    ...
    saveButton = form.getButton("shift.saveButton");
    saveButton.addActionListener(actionListener);
    cancelButton = form.getButton("shift.cancelButton");
