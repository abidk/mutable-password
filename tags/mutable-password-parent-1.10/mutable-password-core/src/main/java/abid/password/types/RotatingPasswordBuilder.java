...
/**
 * Convenient builder class to build Rotating password.
 * 
 * @author Abid
 * 
 */
public class RotatingPasswordBuilder extends MutablePasswordBuilder {

  /**
   * Builds Rotating Password.
   */
  public RotatingPasswordBuilder() {
    super(RotatingPassword.PASSWORD_TYPE);
  }
